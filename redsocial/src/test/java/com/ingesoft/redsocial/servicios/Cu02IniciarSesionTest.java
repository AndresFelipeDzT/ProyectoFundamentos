...
class Cu02IniciarSesionTest {
    ...
    assertThrows(UsuarioNotFoundException.class, () -> usuarioService.iniciarSesion("noexiste", "pwd"));
    }
    ...
    assertThrows(PasswordMismatchException.class, () -> usuarioService.iniciarSesion("ana", "incorrecto"));
    }
